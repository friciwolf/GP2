...
\begin{figure}[H]
	\centering
	\subfloat{{\includegraphics[width=7cm]{Python/lambda_roh_LinReg} }}
	\qquad
	\subfloat{{\includegraphics[width=7cm]{Python/lambda_roh_Residuen} }}
...
\begin{figure}[H]
	\centering
	\subfloat{{\includegraphics[width=7cm]{Python/Lambda1_mResiduen} }}
	\qquad
	\subfloat{{\includegraphics[width=7cm]{Python/Lambda2_mResiduen} }}
	\label{}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat{{\includegraphics[width=7cm]{Python/Lambda3_mResiduen} }}
	\qquad
	\subfloat{{\includegraphics[width=7cm]{Python/Lambda4_mResiduen} }}
