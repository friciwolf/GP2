...
kalibfile1=np.genfromtxt('Mariakalibrierung1.txt')
kalibfile1=kalibfile1[0,:]
kalibfile2=np.genfromtxt('Mariakalibrierung2.txt')
...
s=np.array(data[3]) #  in mm


#                                            
m=np.array([0,10,10,10,10,10,10,10,10,10,10,10,10,10])
...
np.savetxt('Marialambda.txt', [Lambda, elinreglambda, elambda])